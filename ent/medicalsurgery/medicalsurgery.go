...
const (
	// Label holds the string label denoting the medicalsurgery type in the database.
	Label = "medical_surgery"
...
// Columns holds all SQL columns for medicalsurgery fields.
var Columns = []string{
	FieldID,
...
// OrderOption defines the ordering options for the MedicalSurgery queries.
