...
type medicalTreatmentGrpcValidator struct {
	logger                     *zap.SugaredLogger
	medicalHistoriesRepository repository.MedicalHistoriesRepository
}

func NewMedicalTreatmentValidator(
	logger *zap.SugaredLogger,
	medicalHistoriesRepository repository.MedicalHistoriesRepository,
) MedicalTreatmentValidator {
	return &medicalTreatmentGrpcValidator{
		logger:                     logger,
		medicalHistoriesRepository: medicalHistoriesRepository,
	}
}

func (v *medicalTreatmentGrpcValidator) ValidateUpsertMedicalTreatmentRequest(ctx context.Context, req *patient.UpsertMedicalTreatmentRequest) error {
